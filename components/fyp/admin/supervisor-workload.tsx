      ...
      <CardContent>
        <div className="space-y-4">
          {workload.map((item) => {
            ...
            return (
              <div key={item.supervisor.id} className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium truncate">{item.supervisor.full_name}</p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="secondary" className="bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300 shrink-0">
                      {item.active} Active
                    </Badge>
                    <Badge variant="default" className="bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300 shrink-0">
                      {item.completed} Done
                    </Badge>
                  </div>
                </div>
