...
export default function LeadClustersPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero Header */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500/20 via-orange-500/20 to-yellow-500/20 border border-white/10 backdrop-blur-xl p-8">
        <div className="absolute top-0 right-0 w-64 h-64 bg-amber-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
        <div className="relative text-center">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-white via-amber-100 to-orange-100 bg-clip-text text-transparent">My Clusters</h1>
          <p className="text-slate-300 mt-2">
            Manage the clusters you lead and oversee member participation.
          </p>
        </div>
      </div>
